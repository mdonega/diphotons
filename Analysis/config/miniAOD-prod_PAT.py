...
# with command line options: miniAOD-prod -s PAT --eventcontent MINIAODSIM --runUnscheduled --mc --conditions MCRUN2_74_V7::All --no_exec
...
process.GlobalTag = GlobalTag(process.GlobalTag, 'MCRUN2_74_V7::All', '')
